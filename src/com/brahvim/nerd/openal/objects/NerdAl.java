...
public class NerdAl {
    ...
    /**
     * An enum listing all OpenAL extensions this library uses. Any OpenAL
     * drivers ("implementations") you use with this library, need to support
     * them too.
     */
    public enum NerdAlExtensionsInfo {
        ...
        /**
         * Refers to {@code ALC_EXT_disconnect}, which comes primarily from
         * OpenAL Soft.
         */
        EXT_DISCONNECT("ALC_EXT_disconnect"),
        /**
         * Refers to {@code ALC_ENUMERATION_EXT}, a standard extension to OpenAL
         * that should be included with drivers for PC platforms.
         */
    ...
    // region Construction.
    /**
     * Creates OpenAL objects (an {@link AlDevice} and an {@link AlContext} on
     * it) for the "default" physical device connected.
     *
     * @see AlDevice#changeEndpoint(String) Use this method to change the
     *      physical device later without losing any objects already created.
     */
    public NerdAl() {
    ...
    /**
     * Lets this {@link NerdAl} instance wrap the given {@link AlContext}
     * object.
     *
     * @param p_context is the {@link AlContext} this {@link NerdAl} instance
     *                  will wrap.
     */
    ...
    /**
     * Lets this {@link NerdAl} instance construct, then wrap an
     * {@link AlContext} wrapper object given settings to initialize it.
     *
    ...
    /**
     * Lets this {@link NerdAl} instance construct, then wrap an
     * {@link AlContext} wrapper object constructed on the given
     * {@link AlDevice}, given settings to initialize said {@link AlContext}.
     *
    ...
    /**
     * Lets this {@link NerdAl} instance construct, then wrap an
     * {@link AlContext} (given settings to initialize it) constructed on an
     ...
     *                             automatically created {@link AlDevice} will
     *                             output to.
     * @param p_settings           specifies initialization settings for the
     *                             {@link AlContext} to create.
     */
    ...
    /**
     * Creates an abstract, OpenAL "device" object ({@link AlDevice} instance)
     * given just the name of a physical device to connect to.
     *
     ...
     *                          ({@link AlDevice}
     *                          instance) to be used for making {@code alc*()}
     *                          calls.
     * @param p_contextSettings are the settings to create the {@link AlContext}
     *                          object to wrap.
     * @return The {@link AlContext} this {@link NerdAl} instance will wrap.
