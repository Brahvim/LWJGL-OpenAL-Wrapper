...
/**
 * Allows for {@link AlBuffer}s ({@link AlOggBuffer}s for now) to be put into
 * the queue of an {@link AlSource}, essentially allowing for a stream of audio
 * buffers. Yes, this means reading from files as-we-go, or networking!
 *
 * <p>
