...
public class AlAuxiliaryEffectSlot extends AlNativeResource<Integer> {
    ...
    protected AlEffect supplyNonExistentEffect() {
        ...
        switch (effectType) {
            case EXTEfx.AL_EFFECT_EAXREVERB: // -> {
                return new AlEaxReverb(super.MAN);
            // }

            case EXTEfx.AL_EFFECT_REVERB: // -> {
                return new AlReverb(super.MAN);
            // }

            case EXTEfx.AL_EFFECT_CHORUS: // -> {
                return new AlChorus(super.MAN);
            // }

            case EXTEfx.AL_EFFECT_DISTORTION: // -> {
                return new AlDistortion(super.MAN);
            // }

            case EXTEfx.AL_EFFECT_ECHO: // -> {
                return new AlEcho(super.MAN);
            // }

            case EXTEfx.AL_EFFECT_FLANGER: // -> {
                return new AlFlanger(super.MAN);
            // }

            case EXTEfx.AL_EFFECT_FREQUENCY_SHIFTER: // -> {
                return new AlFrequencyShifter(super.MAN);
            // }

            case EXTEfx.AL_EFFECT_VOCAL_MORPHER: // -> {
                throw new AlUnflaggedException("LWJGL has not yet implemented `AL_VOCAL_MORPHER`, sorry.");
            ...
            case EXTEfx.AL_EFFECT_PITCH_SHIFTER: // -> {
                return new AlPitchShifter(super.MAN);
            // }

            case EXTEfx.AL_EFFECT_RING_MODULATOR: // -> {
                return new AlRingModulator(super.MAN);
            // }

            case EXTEfx.AL_EFFECT_AUTOWAH: // -> {
                return new AlAutowah(super.MAN);
            // }

            case EXTEfx.AL_EFFECT_COMPRESSOR: // -> {
                return new AlCompressor(super.MAN);
            // }

            case EXTEfx.AL_EFFECT_EQUALIZER: // -> {
     ...
     *         {@link AlAuxiliaryEffectSlot}. {@link AlEffect#NULL_AL_EFFECT} if no
     *         {@link AlEffect} is attached.
     */
